...
import com.sh.dilyly.adapter.list.CyclicalAdapter;
...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public int getViewsCount() {
		if (mAdapter instanceof CyclicalAdapter) {
			return ((CyclicalAdapter)mAdapter).getActualCount();
		}
	...
	public void snapToNext() {
		...
		Log.e("snapToNext", mCurrentScreen + "/" + count);
	}
